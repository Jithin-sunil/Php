...
if(isset($_POST['btn_submit'])) {
    ...
    $path = "../Assets/Files/Shop/".$proof;
    move_uploaded_file($temp, $path);
    
    // Check if email already exists
    $checkEmail = "SELECT * FROM tbl_shop WHERE shop_email = '$email'";
    ...
    if($result->num_rows > 0) {
        ...
        $insQry = "INSERT INTO tbl_shop (shop_name, shop_email, shop_password, shop_contact, shop_address, place_id, shop_photo, shop_proof) 
                   VALUES ('$name', '$email', '$password', '$contact', '$address',  '$place', '$photo', '$proof')";
